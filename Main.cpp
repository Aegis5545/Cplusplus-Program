// Project-3-Correct.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
//Author: Cooper David
//Date: 8/12/2023
...
//The Function for searching for items
void StoreItems::FindItem(string inputWord) {
	...
	foundItems.push_back(inputWord); //Pushes back inputWord
	itemQuantity.push_back(itemCount); //Pushes back itemCount
	cout << "" << endl;
...
//creates the .dat file with search results
...
int main() {
	...
	//Loops while user does not want to exit
	while (userInput != 4) {
	...
	//Exit message and file creation
